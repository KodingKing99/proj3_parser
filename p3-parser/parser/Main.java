...
//      // [[G -> ● N, $], [N -> ● N X, $], [N -> ● N X, X], [N -> ● X, X], [N -> ● X, $]]
   ...
   }
   {
     ...
     // What I got 
     // [pair -> OPAREN ● list CPAREN, $], [list -> ● list pair, CPAREN], [list -> ● list pair, OPAREN], [list -> ● pair, OPAREN], 
     // [pair -> ● OPAREN list CPAREN, OPAREN], [pair -> ● OPAREN CPAREN, OPAREN], 
     // [list -> ● pair, CPAREN], [pair -> ● OPAREN list CPAREN, CPAREN], [pair -> ● OPAREN CPAREN, CPAREN]
